...
public class ChatHelper {
    ...
    public void register (Uri chatServer, String chatName, ResultReceiverWrapper resultReceiver) {
        if (chatName != null && !chatName.isEmpty()) {
            // TODOX register with the cloud chat service
    ...
    public void postMessage(String chatRoom, String messageText, ResultReceiverWrapper receiver) {
        if (messageText != null && !messageText.isEmpty()) {
            ...
            /*
             * TODOX enqueue a request with workManager to post this message
             *
    ...
    public void startMessageSync() {
        if (Settings.SYNC) {
            ...
            // TODOX schedule periodic synchronization with message database
    ...
    public void stopMessageSync() {
        if (Settings.SYNC) {
            ...
            // TODOX cancel periodic synchronization with message database
